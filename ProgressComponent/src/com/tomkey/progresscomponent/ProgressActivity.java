    ...
    private void setContentShown(boolean shown, boolean animate) {
        ...
        if (shown) {
            if (animate) {
                ...
                mContentContainer.startAnimation(AnimationUtils.loadAnimation(this, android.R.anim.fade_in));
            } else {
            ...
            if (animate) {
                ...
                mContentContainer.startAnimation(AnimationUtils.loadAnimation(this, android.R.anim.fade_out));
            } else {
                mProgressContainer.clearAnimation();
                mContentContainer.clearAnimation();
            }
